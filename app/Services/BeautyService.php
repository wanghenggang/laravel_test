...
class BeautyService
{
    public string $domain = 'https://www.beautyforever.com/beautyforever-upgraded-durable-v-shape-glueless-wig-human-hair-body-wave-beginner-friendly-natural-v-part-wig.html';

    public function spider()
    {
        // Create Spider
        $spider = new Spider($this->domain);
